...
| **Quick.Link** | Create and manage custom short links via YOURLS | 🟢 **v2.1.2** | iOS/macOS | [🔗 App Store](https://one13.link/quick-link-dl)
...
| **Link-in-Bio Site** | A minimal, elegant link-in-bio template built in HTML | 🟢 **4/18/26** | [🔗 Demo](https://bio.one13.me) | [📂 Repository](https://github.com/onethirteenco/link-in-bio)
